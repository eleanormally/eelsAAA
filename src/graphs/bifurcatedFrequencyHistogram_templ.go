...
func listEntries(entries []entry, id string) templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_listEntries_cc3d`,
		Function: `function __templ_listEntries_cc3d(entries, id){const svg = d3.select("#"+id)
  let g = svg.append("g")
  ...
  g.selectAll("text").data(entries).enter()
      ...
      g.selectAll("text").data(entries)
		...
		Call:       templ.SafeScript(`__templ_listEntries_cc3d`, entries, id),
		CallInline: templ.SafeScriptInline(`__templ_listEntries_cc3d`, entries, id),
	}
}
